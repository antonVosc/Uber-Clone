  ...
  <div id="Home" class="flex flex-col h-screen">
    <div class="m-3 mb-auto">
      ...
      <div class="grid grid-cols-2 gap-3 my-3">
        ...
        <ServiceSelectLarge text="Food" imageWidth="72" image="food" :promo="true" />
      </div>
      ...
      <div class="w-full bg-custom-color h-14 rounded-full flex items-center p-3">
        ...
        <div class="ml-3 text-xs font-semibold text-grey-700">
          Enter pick-up point
        </div>
      </div>
    </div>
    ...
    <footer class="w-full z-50 flex justify-around p-1 mb-2 border-t-2 border-t-gray-200">
      <div class="grid place-items-center">
        ...
        <div class="w-full -mt-2 text-xs text-center text-gray-800 font-semibold">
          Home
        </div>
      </div>
      ...
      <div class="grid place-items-center">
        ...
        <div class="w-full -mt-2 text-xs text-center text-gray-400 font-semibold">
          Destination
        </div>
      </div>
    </footer>
